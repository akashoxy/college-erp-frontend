                  ...
                  >
                    ...
                    <div className="card-body">
                      ...
                      <div className="flex items-center gap-5">
                        ...
                        <div className="w-16 h-16 rounded-2xl bg-primary text-primary-content flex items-center justify-center">
                        ...
                        <div>
                          ...
                          <h3 className="text-2xl font-black">
                            ...
                            Objective{" "}
                            {(index % data.objectives.length) + 1}
          ...
          <div className="marquee py-5">
            ...
            <div className="marquee-track-normal">
              ...
              {[
                ...
                <div
                  key={index}
                  className="card bg-base-200 border border-base-300 shadow-xl w-95 md:w-100 rounded-3xl shrink-0 hover:-translate-y-3 hover:scale-[1.02] hover:shadow-[0_20px_60px_rgba(0,0,0,.18)] transition-all duration-300"
                >
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="card bg-base-200 border border-base-300 shadow-xl hover:shadow-2xl transition-all hover:-translate-y-2">
